...
public class TheMainClass {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("The weight is " + someStudent.calcBMI() + "\n");
		...
		System.out.println("The last name is " + someOtherStudent.height + "\n");
		System.out.println("The last name is " + someOtherStudent.weight + "\n");
		System.out.println("The last name is " + someOtherStudent.calcBMI() + "\n");
